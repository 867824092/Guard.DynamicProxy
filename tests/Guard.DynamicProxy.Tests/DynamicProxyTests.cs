...
namespace Guard.DynamicProxy.Tests {
    public class DynamicProxyTests {
        ...
        public void Should_True_Create_Wushen_Proxy() {
            ...
            Assert.True(calculator.Multiply(1,3) == 3);
        }
        [Fact]
        public void Should_True_Create_Proxy_With_Target() {
            var calculator = (Calculate)ProxyGenerator.CreateClassProxyWithTarget(typeof(Calculate),new Calculate(), new LogInterceptor());
